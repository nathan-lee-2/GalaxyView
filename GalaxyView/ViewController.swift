...
class ViewController: UIViewController {
    ...
    //an outdated helper function to save the image to users photo library
    //useless because of the below action but I'll leave it here just in case
    ...
    //should give a popup that allows users to save image to their photo library or share it
